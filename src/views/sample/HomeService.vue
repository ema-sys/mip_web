      ...
      <v-row class="home-service__contents">
        <v-col md="3">
          <v-card to="/service#direction" hover>
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="@/assets/card-1.png" alt="ディレクション">
            </div>
        ...
        <v-col md="3">
          <v-card to="/service#coding" hover>
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="@/assets/card-2.png" alt="コーディング">
            </div>
            <div class="home-service__card-text">
              <p>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
            </div>
        ...
        <v-col md="3">
          <v-card to="/service#design" hover>
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="@/assets/card-3.png" alt="デザイン">
            </div>
            <div class="home-service__card-text">
              <p>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
            </div>
